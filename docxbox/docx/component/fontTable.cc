...
void fontTable::CollectFontsMetrics(std::string fontTable_xml) {
...
void fontTable::InitCliOutputPadding() {
...
void fontTable::OutputPlain(const std::string& path_xml_file) {
  ...
  std::cout << helper::String::Repeat("-", max_len_font_name_) << "    "
...
void fontTable::OutputAsJson(const std::string& path_xml_file) {
  std::cout << "{"
            << R"("xml": ")" << path_xml_file << "\","
            << "\"fonts\":[";
