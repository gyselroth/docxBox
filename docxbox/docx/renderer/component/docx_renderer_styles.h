...
#ifndef DOCXBOX_DOCX_RENDERER_COMPONENT_DOCX_RENDERER_STYLES_H_
#define DOCXBOX_DOCX_RENDERER_COMPONENT_DOCX_RENDERER_STYLES_H_
...
#endif  // DOCXBOX_DOCX_RENDERER_COMPONENT_DOCX_RENDERER_STYLES_H_
