...
@test "With \"docxbox mm filename.docx title {argument}\" the meta attribute title can be changeg" {
...
@test "With \"docxbox mm filename.docx creator {argument}\" the meta attribute creator can be changeg" {
...
@test "With \"docxbox mm filename.docx lastModifiedBy {argument}\" the meta attribute lastModifiedBy can be changeg" {
...
@test "With \"docxbox mm filename.docx lastPrinted {argument}\" the meta attribute lastPrinted can be changeg" {
...
@test "With \"docxbox mm filename.docx language {argument}\" the meta attribute language can be changeg" {
...
@test "With \"docxbox mm filename.docx modified {argument}\" the meta attribute modified can be changeg" {
...
@test "With \"docxbox mm filename.docx created {argument}\" the meta attribute created can be changeg" {
...
@test "With \"docxbox mm filename.docx revision {argument}\" the meta attribute revision can be changeg" {
