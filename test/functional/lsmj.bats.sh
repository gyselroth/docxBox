...
@test "Exit code of \"docxbox lsmj filename.docx\" is zero" {
  run "$BATS_TEST_DIRNAME"/docxbox lsmj test/functional/tmp/cp_table_unordered_list_images.docx
  [ "$status" -eq 0 ]
}
...
@test "Output of \"docxbox lsmj filename.docx\" contains information about the xml schema" {
  "$BATS_TEST_DIRNAME"/docxbox lsmj test/functional/tmp/cp_table_unordered_list_images.docx | grep -c "\"xmlSchema\": \"http://schemas.openxmlformats.org/officeDocument/2006\""
}
...
@test "Output of \"docxbox lsm filename.docx -j\" contains information about the creation time and date" {
  "$BATS_TEST_DIRNAME"/docxbox lsm test/functional/tmp/cp_table_unordered_list_images.docx -j | grep -c "\"created\": \"2017-08-02T11:09:18Z\""
}

@test "Output of \"docxbox ls filename.docx --meta --json\" contains information about the creation time and date" {
  "$BATS_TEST_DIRNAME"/docxbox ls test/functional/tmp/cp_table_unordered_list_images.docx --meta --json | grep -c "\"created\": \"2017-08-02T11:09:18Z\""
}

@test "Output of \"docxbox ls filename.docx -mj\" contains information about the creation time and date" {
  "$BATS_TEST_DIRNAME"/docxbox ls test/functional/tmp/cp_table_unordered_list_images.docx -mj | grep -c "\"created\": \"2017-08-02T11:09:18Z\""
}

@test "Output of \"docxbox lsmj filename.docx\" contains language information" {
  "$BATS_TEST_DIRNAME"/docxbox lsmj test/functional/tmp/cp_table_unordered_list_images.docx | grep -c "\"language\": \"en-US\""
}

@test "Output of \"docxbox lsmj filename.docx\" contains information about the revision" {
  "$BATS_TEST_DIRNAME"/docxbox lsmj test/functional/tmp/cp_table_unordered_list_images.docx | grep -c "\"revision\": \"0\""
}
